/**
 * imagePreloader.js - Image Preloading Utility
 * 
 * Pre-loads and caches images at app startup to prevent loading delays during navigation.
 * 
 * Features:
 * - Pre-resolves image assets at module load time
 * - Caches logo images for instant display
 * - Exports resolved image sources for use throughout the app
 * 
