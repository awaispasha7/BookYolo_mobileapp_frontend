/**
 * automaticNotificationService.js - Automatic Notification Service
 * 
 * Service for automatically sending notifications based on app events
 * (e.g., scan completion, comparison results, etc.).
 * 
 * Features:
