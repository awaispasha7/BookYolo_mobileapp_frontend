/**
 * lockScreenNotificationService.js - Lock Screen Notification Service
 * 
 * Specialized service for sending notifications that appear on the device lock screen.
 * 
 * Features:
 * - High-priority notifications for lock screen display
