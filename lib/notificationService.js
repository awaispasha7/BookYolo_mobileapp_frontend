 ...
 * 
 * Manages push notifications for the app using Expo Notifications and Supabase.
 * 
 * Features:
 * - Push notification registration and token management
 * - Notification permissions handling
 * - Notification display and interaction
 * - Navigation integration (navigate on notification tap)
 * 
 * Updated: January 2026 - Repository sync
 * - Supabase integration for notification storage
 * - Background notification handling
 * 
 * Note: Some notification services (background, lock screen, automatic) are disabled
