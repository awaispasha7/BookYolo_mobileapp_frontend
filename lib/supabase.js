 ...
 * 
 * Initializes and exports the Supabase client for database and real-time features.
 * Used primarily for push notification storage and management.
 * 
 * Features:
 * - Supabase client initialization
 * - Connection to BookYolo Supabase project
 * - Used by notification service for storing notification tokens
 */
