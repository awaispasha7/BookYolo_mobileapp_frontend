/**
 * octopusEmailService.js - Octopus Email Marketing Integration
 * 
 * Handles integration with Octopus email marketing service.
 * Adds users to Octopus contacts after email verification.
 * 
 * Features:
 * - Add users to Octopus contacts with "New User" tag
 * - Integration with backend API endpoint
 * - Error handling and logging
 * 
 * Usage:
 * - Called automatically after successful email verification
 * - Can be called manually to sync user data
 */
