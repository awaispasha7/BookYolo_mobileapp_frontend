    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 24 }}>
        ...
        <View style={[styles.planCard, styles.card]}>
          ...
          <Text style={styles.planFeature}>✓ Deep inspection prompt (GPT‑4o mini)</Text>
          <Text style={styles.planFeature}>✓ Structured data analysis</Text>
          <Text style={styles.planFeature}>✓ Fair Personal Use: up to 50 total per year</Text>
          <Text style={styles.featureNote}>Scans + questions + compares count toward 50</Text>
        </View>
        ...
        <View style={[styles.planCard, styles.card, styles.premiumCard]}>
          ...
          <Text style={styles.billingText}>per year • auto‑renew via Stripe</Text>
          <View style={styles.divider} />
          <Text style={styles.sectionTitle}>Everything in Free, plus</Text>
          <Text style={styles.planFeature}>✓ +300 extra scans/questions per year</Text>
          <Text style={styles.planFeature}>✓ Priority for future features</Text>
          <Text style={styles.planFeature}>✓ Personal use only</Text>
          ...
          >
            {loading ? (
              ...
              <Text style={styles.ctaText}>
                {userPlan === 'premium' ? 'Already Premium' : 'Upgrade for $20/year'}
              </Text>
            )}
          </TouchableOpacity>
          <TouchableOpacity 
        ...
        <View style={styles.notesBox}>
          <Text style={styles.noteItem}>• Usage caps: 50/yr on Free, 300/yr extra on Premium.</Text>
          <Text style={styles.noteItem}>• Invalid URLs don’t count toward your balance.</Text>
          <Text style={styles.noteItem}>• You can upgrade/downgrade anytime in account settings.</Text>
        </View>
